...
formats is T3 (unverified)**; proven: T1=8, T1b=66, T2=11. 9 hardware controllers
...
- **1 of 88 tier-tracked formats is unverified (T3).** Proven: T1=8,
  T1b=66, T2=11, and 2 carry `n/a` because they are not container
...
for the tier definitions): **T1=8, T1b=66, T2=11, T3=1, n/a=2** of 88.
