...
[`docs/VERIFICATION_TIERS.md`](docs/VERIFICATION_TIERS.md) — **16 of 88
formats are T3 (unverified)**; proven: T1=2, T1b=37, T2=33. 9 hardware controllers
...
- **16 of 88 tier-tracked formats are unverified (T3).** Proven: T1=2,
  T1b=37, T2=33. (Was 57/17 — `mfi` and then `d77` moved up in v4.1.7,
...
for the tier definitions): **T1=2, T1b=37, T2=33, T3=16** of 88.
