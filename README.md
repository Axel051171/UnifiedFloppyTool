...
formats are T3 (unverified)**; proven: T1=8, T1b=58, T2=18. 9 hardware controllers
...
- **2 of 88 tier-tracked formats are unverified (T3).** Proven: T1=8,
  T1b=58, T2=18, and 2 carry `n/a` because they are not container
...
for the tier definitions): **T1=8, T1b=58, T2=18, T3=2, n/a=2** of 88.
