...
formats are T3 (unverified)**; proven: T1=2, T1b=25, T2=23. 9 hardware controllers
...
- **50 of 88 tier-tracked formats are unverified (T3).** Proven: T1=2,
  T1b=25, T2=23. (Was 57/17 — `mfi` and then `d77` moved up in v4.1.7,
...
for the tier definitions): **T1=2, T1b=25, T2=23, T3=38** of 88.
