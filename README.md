...
formats are T3 (unverified)**; proven: T1=2, T1b=52, T2=29. 9 hardware controllers
...
- **5 of 88 tier-tracked formats are unverified (T3).** Proven: T1=2,
  T1b=52, T2=29. (Was 57/17 — `mfi` and then `d77` moved up in v4.1.7,
...
for the tier definitions): **T1=2, T1b=52, T2=29, T3=5** of 88.
