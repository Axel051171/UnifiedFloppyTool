...
[![Build](https://github.com/YOUR_USERNAME/UnifiedFloppyTool/actions/workflows/build.yml/badge.svg)](https://github.com/YOUR_USERNAME/UnifiedFloppyTool/actions/workflows/build.yml)
[![Release](https://img.shields.io/github/v/release/YOUR_USERNAME/UnifiedFloppyTool)](https://github.com/YOUR_USERNAME/UnifiedFloppyTool/releases)
[![License](https://img.shields.io/github/license/YOUR_USERNAME/UnifiedFloppyTool)](LICENSE)
...
| Platform | Download |
|----------|----------|
| Windows | [UnifiedFloppyTool-x.x.x-windows-x64.tar.gz](https://github.com/YOUR_USERNAME/UnifiedFloppyTool/releases/latest) |
| macOS | [UnifiedFloppyTool-x.x.x-macos-x64.tar.gz](https://github.com/YOUR_USERNAME/UnifiedFloppyTool/releases/latest) |
| Linux | [UnifiedFloppyTool-x.x.x-linux-x64.tar.gz](https://github.com/YOUR_USERNAME/UnifiedFloppyTool/releases/latest) |
| Linux (.deb) | [unifiedfloppytool_x.x.x_amd64.deb](https://github.com/YOUR_USERNAME/UnifiedFloppyTool/releases/latest) |
