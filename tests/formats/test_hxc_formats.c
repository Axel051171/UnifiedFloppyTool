...
static void test_format_detection_woz(void)
{
    ...
    uft_hxc_format_t format;
    uint8_t confidence;
    int ret = uft_hxc_detect_format(data, sizeof(data), &format, &confidence);
    
    TEST_ASSERT(ret == 0);
    TEST_ASSERT(format == UFT_HXC_FMT_WOZ_V2);
...
static void test_format_detection_scp(void)
{
    ...
    TEST_ASSERT(ret == 0);
    TEST_ASSERT(format == UFT_HXC_FMT_SCP);
    TEST_ASSERT(confidence >= 90);
...
static void test_format_detection_hfe(void)
{
    ...
    TEST_ASSERT(ret == 0);
    TEST_ASSERT(format == UFT_HXC_FMT_HFE_V1);
    TEST_ASSERT(confidence >= 90);
    ...
    ret = uft_hxc_detect_format(data, sizeof(data), &format, &confidence);
    
    TEST_ASSERT(ret == 0);
    TEST_ASSERT(format == UFT_HXC_FMT_HFE_V3);
    TEST_ASSERT(confidence >= 90);
...
static void test_format_detection_ipf(void)
{
    ...
    TEST_ASSERT(ret == 0);
    TEST_ASSERT(format == UFT_HXC_FMT_IPF);
    TEST_ASSERT(confidence >= 90);
...
static void test_format_detection_g64(void)
{
    ...
    TEST_ASSERT(ret == 0);
    TEST_ASSERT(format == UFT_HXC_FMT_G64);
    TEST_ASSERT(confidence >= 90);
...
static void test_format_detection_stx(void)
{
    ...
    TEST_ASSERT(ret == 0);
    TEST_ASSERT(format == UFT_HXC_FMT_STX);
    TEST_ASSERT(confidence >= 90);
...
static void test_format_detection_imd(void)
{
    ...
    TEST_ASSERT(ret == 0);
    TEST_ASSERT(format == UFT_HXC_FMT_IMD);
    TEST_ASSERT(confidence >= 90);
...
static void test_format_names(void)
{
    ...
    TEST_ASSERT(strcmp(uft_hxc_format_name(UFT_HXC_FMT_WOZ_V1), "WOZ v1") == 0);
    TEST_ASSERT(strcmp(uft_hxc_format_name(UFT_HXC_FMT_WOZ_V2), "WOZ v2") == 0);
    TEST_ASSERT(strcmp(uft_hxc_format_name(UFT_HXC_FMT_SCP), "SuperCard Pro") == 0);
    TEST_ASSERT(strcmp(uft_hxc_format_name(UFT_HXC_FMT_IPF), "IPF (CAPS/SPS)") == 0);
    TEST_ASSERT(strcmp(uft_hxc_format_name(UFT_HXC_FMT_KRYOFLUX), "KryoFlux Stream") == 0);
    TEST_ASSERT(strcmp(uft_hxc_format_name(UFT_HXC_FMT_D64), "D64 (C64)") == 0);
    TEST_ASSERT(strcmp(uft_hxc_format_name(UFT_HXC_FMT_ADF), "ADF (Amiga)") == 0);
    TEST_ASSERT(strcmp(uft_hxc_format_name(UFT_HXC_FMT_HFE_V1), "HFE v1") == 0);
    
    /* Unknown format */
    TEST_ASSERT(strcmp(uft_hxc_format_name((uft_hxc_format_t)9999), "Unknown") == 0);
...
static void test_format_classification(void)
{
    ...
    /* Flux formats */
    TEST_ASSERT(uft_hxc_is_flux_format(UFT_HXC_FMT_SCP) == true);
    TEST_ASSERT(uft_hxc_is_flux_format(UFT_HXC_FMT_KRYOFLUX) == true);
    TEST_ASSERT(uft_hxc_is_flux_format(UFT_HXC_FMT_A2R) == true);
    
    /* Non-flux formats */
    TEST_ASSERT(uft_hxc_is_flux_format(UFT_HXC_FMT_D64) == false);
    TEST_ASSERT(uft_hxc_is_flux_format(UFT_HXC_FMT_ADF) == false);
    TEST_ASSERT(uft_hxc_is_flux_format(UFT_HXC_FMT_IMG) == false);
    
    /* Preservation formats */
    TEST_ASSERT(uft_hxc_is_preservation_format(UFT_HXC_FMT_SCP) == true);
    TEST_ASSERT(uft_hxc_is_preservation_format(UFT_HXC_FMT_IPF) == true);
    TEST_ASSERT(uft_hxc_is_preservation_format(UFT_HXC_FMT_KRYOFLUX) == true);
    TEST_ASSERT(uft_hxc_is_preservation_format(UFT_HXC_FMT_G64) == true);
    
    /* Non-preservation formats */
    TEST_ASSERT(uft_hxc_is_preservation_format(UFT_HXC_FMT_D64) == false);
    TEST_ASSERT(uft_hxc_is_preservation_format(UFT_HXC_FMT_ADF) == false);
...
void run_hxc_format_tests(void)
{
    printf("\n=== HxC Format Tests ===\n\n");
