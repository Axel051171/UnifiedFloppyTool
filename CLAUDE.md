...
> Plugins stehen **36 auf T3 — ungeprüft** (MF-654: `adl` und
...
| **Befund** | **7** offene Zeilen | [`docs/QUARANTINE.md`](docs/QUARANTINE.md) | auditiert, Weg festgelegt oder ausstehend |
