...
#ifndef LIBFLUX_FM_ENCODING_H
#define LIBFLUX_FM_ENCODING_H
...
void FastFMgenerator(track_generator *tg,LIBFLUX_SIDE * side,unsigned char * track_data,int size);

#ifdef __cplusplus
}
#endif

#endif /* LIBFLUX_FM_ENCODING_H */
