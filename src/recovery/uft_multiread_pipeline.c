...
/* MF-215: the constants, error enum and structs that used to be defined
 * inline here now live in the public header so this implemented module
 * has a callable/testable surface. Pure extraction — no behaviour
 * changed. See include/uft/recovery/uft_multiread_pipeline.h. */
