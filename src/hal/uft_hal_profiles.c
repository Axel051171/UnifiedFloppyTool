...
const uft_drive_profile_t UFT_DRIVE_PROFILE_525_DD = {
    ...
    .data_rate_dd_kbps = 250.0,
    .bit_cell_dd_us = 4.0,     // FM: 4µs, MFM: 2µs
...
const uft_drive_profile_t UFT_DRIVE_PROFILE_CBM_1541 = {
    ...
    .data_rate_dd_kbps = 0,      // Variable by zone
    .bit_cell_dd_us = 0,       // GCR timing varies
