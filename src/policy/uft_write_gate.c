...
/* Magic-byte constants. Some are unused yet — reserved for planned
 * size+magic checks not yet wired into FORMAT_SIGS. Kept for docs. */
__attribute__((unused))
static const uint8_t MAGIC_ADF_BOOT[] = {0x44, 0x4F, 0x53};
__attribute__((unused))
static const uint8_t MAGIC_D64_BAM[] = {0x12, 0x01, 0x41};
static const uint8_t MAGIC_SCL[] = {'S','I','N','C','L','A','I','R'};
__attribute__((unused))
static const uint8_t MAGIC_TRD[] = {0x00};
...
__attribute__((unused))
static const uint8_t MAGIC_NIB[] = {0};
