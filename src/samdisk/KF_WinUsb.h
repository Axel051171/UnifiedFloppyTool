...
class UFT_KF_WinUsb final : public KryoFlux
{
public:
    UFT_KF_WinUsb(HANDLE hdev, WINUSB_INTERFACE_HANDLE winusb, WINUSB_INTERFACE_HANDLE interface1);
    ~UFT_KF_WinUsb();
...
private:
    std::string UFT_KF_WinUsb::GetProductName() override;
