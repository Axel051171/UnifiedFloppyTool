                                    ...
                                    uft_track_t *track)
{
    ...
    for (int s = 0; s < spt; s++) {
         ...
         * damit von echten Daten nicht zu unterscheiden. Hier gibt es
         * ZWEI Fehlerwege (Positionierung und Lesen); beide zaehlen. */
        bool kurz = false;
...
static const uft_plugin_feature_t uft_format_plugin_d67_features[] = {
...
const uft_format_plugin_t uft_format_plugin_d67 = {
    ...
    .features = uft_format_plugin_d67_features,  /* V415-PLAN PLUGIN.features (MF-263) */
    .feature_count = sizeof(uft_format_plugin_d67_features) / sizeof(uft_format_plugin_d67_features[0]),
};
