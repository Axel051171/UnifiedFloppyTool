...
static const uft_plugin_feature_t uft_format_plugin_jvc_features[] = {
...
const uft_format_plugin_t uft_format_plugin_jvc = {
    ...
    .features = uft_format_plugin_jvc_features,  /* V415-PLAN PLUGIN.features (MF-263) */
    .feature_count = sizeof(uft_format_plugin_jvc_features) / sizeof(uft_format_plugin_jvc_features[0]),
};
