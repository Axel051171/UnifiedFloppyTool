...
#define UFT_CAPS_FILEEXT "ipf"
#define UFT_CAPS_FILEPFX ".ipf"
...
#define UFT_CAPS_MAXPLATFORM 4
#define UFT_CAPS_MTRS 5
...
struct CapsImageInfo {
	...
	UDWORD platform[UFT_CAPS_MAXPLATFORM]; // intended platform(s)
};
...
struct CapsTrackInfo {
	...
	PUBYTE trackdata[UFT_CAPS_MTRS]; // track data pointer if available
	UDWORD tracksize[UFT_CAPS_MTRS]; // track data size
