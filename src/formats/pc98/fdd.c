...
int uft_floppy_analyze_protection(FloppyDevice*dev){ logm(dev,"Analyzer(FDD): PC-98 emulator format; implement header+geometry inference once we have samples."); return OK; }
