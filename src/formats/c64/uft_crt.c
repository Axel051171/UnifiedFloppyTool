...
/**
 * CRT Cartridge Hardware Types
 * Reference: Peter Schepers, "CRT - CaRTridge Images (from the CCS64 emulator)"
 * Document revision 1.15 (Dec 10, 2009)
 */
static const char *crt_type_names[] = {
    ...
    "Magic Formel",             /* 14 */
    "C64 Game System",          /* 15 - System 3 */
    "Warp Speed",               /* 16 */
    "Dinamic",                  /* 17 */
    "Zaxxon, Super Zaxxon",     /* 18 - SEGA */
    "Magic Desk",               /* 19 - Domark, HES Australia */
                    ...
                    size_t buffer_size, size_t *extracted)
{
    ...
    for (size_t i = 0; i < image->num_chips && total < buffer_size; i++) {
