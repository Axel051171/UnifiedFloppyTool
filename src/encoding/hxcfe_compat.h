/*
 * hxcfe_compat.h - HxCFloppyEmulator Compatibility Layer for UFT
 *
 * Copyright (C) 2006-2025 Jean-François DEL NERO (original HxCFloppyEmulator)
 * Copyright (C) 2025 UFT Project (compatibility layer)
 *
 * This compatibility layer provides the minimal types and functions
 * required to compile HxCFloppyEmulator encoding modules within UFT.
 *
 * SPDX-License-Identifier: GPL-2.0-or-later
 */

#ifndef UFT_HXCFE_COMPAT_H
#define UFT_HXCFE_COMPAT_H
...
/*============================================================================
 * Basic Type Definitions (from HxCFloppyEmulator types.h)
 *============================================================================*/
...
/*============================================================================
 * HxCFE Error Codes (from libhxcfe.h)
 *============================================================================*/
...
/*============================================================================
 * HxCFE Opaque Types (from libhxcfe.h)
 *============================================================================*/
...
/*============================================================================
 * HXCFE_SIDE Structure (from internal_floppy.h)
 *============================================================================*/
...
typedef struct _HXCFE_TRKSTREAM HXCFE_TRKSTREAM;
...
/* Track encoding types - common values used across HxCFloppyEmulator */
