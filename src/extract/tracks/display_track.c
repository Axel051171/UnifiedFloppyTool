...
#define COLOR_RGBA(R,G,B,A) ( ((uint32_t)(R) & 0xFFu) | ( ((uint32_t)(G) & 0xFFu) << 8 ) | ( ((uint32_t)(B) & 0xFFu) << 16 ) | ( ((uint32_t)(A) & 0xFFu) << 24 ) )
#define COLOR_RGB2RGBA(RGB,A) ( (uint32_t)(RGB) | ( ((uint32_t)(A) & 0xFFu) << 24 ) )
