...
/* ============================================================================
 * CHECKSUM VERIFICATION (FIX for TODOs at lines 182, 187, 218)
 * ============================================================================ */
...
static uft_error_t amiga_mfm_decode_track(const uft_flux_track_data_t* flux,
    ...
    while (bit_pos >= 0 && sectors->sector_count < (size_t)(max_sectors + 2)) {
        ...
        /* Verify header checksum (FIX for TODO line 182) */
        ...
        /* Verify data checksum (FIX for TODO line 187) */
        ...
        s->id.crc_ok = hdr_ok;  /* FIX for TODO line 218: proper header check */
