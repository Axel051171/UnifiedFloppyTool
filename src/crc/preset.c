...
/* Forward declaration of aliases table.
 * MSVC requires a size for forward-declared arrays.
 * The actual array is defined below with 188 elements.
 */
#ifdef _MSC_VER
#pragma warning(push)
#pragma warning(disable: 4200)  /* zero-sized array in struct */
static const struct malias aliases[256];  /* MSVC workaround - actual size is 188 */
#pragma warning(pop)
#else
