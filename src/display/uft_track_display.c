                            ...
                            char *buffer, size_t buf_size)
{
    ...
    /* Each sector */
    for (size_t s = 0; s < sectors && pos < buf_size - 100; s++) {
                           ...
                           char *buffer, size_t buf_size)
{
    ...
    for (size_t i = 0; i < count && pos < buf_size - 100; i++) {
                                 ...
                                 char *buffer, size_t buf_size)
{
    ...
    for (size_t i = 0; i < HIST_BINS && pos < buf_size - 100; i++) {
                          ...
                          char *buffer, size_t buf_size)
{
    ...
    for (size_t i = 0; i < count && pos + 200 < buf_size; i += step) {
                             ...
                             int sides, char *buffer, size_t buf_size)
{
    ...
    for (size_t side = 0; side < sides && pos < buf_size - 500; side++) {
