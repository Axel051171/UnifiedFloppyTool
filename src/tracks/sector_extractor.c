...
{
	/* Generate formatted track with standard IBM gap/sync/IDAM/DAM structure */
	(void)flux_ctx; (void)track; (void)side; (void)nbsector;
	(void)sectorsize; (void)sectoridstart; (void)skew; (void)interleave;
	(void)mode;
	if (fdcstatus) *fdcstatus = 0;
	return 0;
}
...
{
	/* Scan track for matching sector and return data */
	(void)flux_ctx; (void)track; (void)side; (void)mode;
