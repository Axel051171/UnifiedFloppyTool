/*
 * ufm_c64_trait_bitlen_jitter.h
 *
 * Bit-length jitter across revolutions
 *
 * Scope (preservation):
 ...
 */
#ifndef UFM_C64_TRAIT_BITLEN_JITTER_H
#define UFM_C64_TRAIT_BITLEN_JITTER_H
...
int ufm_c64_detect_trait_bitlen_jitter(const ufm_c64_track_sig_t* tracks, size_t track_count,
...
#endif /* UFM_C64_TRAIT_BITLEN_JITTER_H */
