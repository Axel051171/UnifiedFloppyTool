/*
 * ufm_c64_trait_marker_bytes.h
 *
 * Marker bytes in decoded stream
 *
 * Scope (preservation):
 ...
 */
#ifndef UFM_C64_TRAIT_MARKER_BYTES_H
#define UFM_C64_TRAIT_MARKER_BYTES_H
...
int ufm_c64_detect_trait_marker_bytes(const ufm_c64_track_sig_t* tracks, size_t track_count,
...
#endif /* UFM_C64_TRAIT_MARKER_BYTES_H */
