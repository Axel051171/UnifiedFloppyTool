/*
 * ufm_c64_trait_dirtrack_anomaly.h
 *
 * Directory track anomaly (track 18)
 *
 * Scope (preservation):
 ...
 */
#ifndef UFM_C64_TRAIT_DIRTRACK_ANOMALY_H
#define UFM_C64_TRAIT_DIRTRACK_ANOMALY_H
...
int ufm_c64_detect_trait_dirtrack_anomaly(const ufm_c64_track_sig_t* tracks, size_t track_count,
...
#endif /* UFM_C64_TRAIT_DIRTRACK_ANOMALY_H */
