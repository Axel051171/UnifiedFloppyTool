/*
 * ufm_c64_trait_illegal_gcr.h
 *
 * Illegal GCR / decode anomalies
 *
 * Scope (preservation):
 ...
 */
#ifndef UFM_C64_TRAIT_ILLEGAL_GCR_H
#define UFM_C64_TRAIT_ILLEGAL_GCR_H
...
int ufm_c64_detect_trait_illegal_gcr(const ufm_c64_track_sig_t* tracks, size_t track_count,
...
#endif /* UFM_C64_TRAIT_ILLEGAL_GCR_H */
