/*
 * ufm_c64_trait_long_sync_run.h
 *
 * Abnormally long sync run
 *
 * Scope (preservation):
 ...
 */
#ifndef UFM_C64_TRAIT_LONG_SYNC_RUN_H
#define UFM_C64_TRAIT_LONG_SYNC_RUN_H
...
int ufm_c64_detect_trait_long_sync_run(const ufm_c64_track_sig_t* tracks, size_t track_count,
...
#endif /* UFM_C64_TRAIT_LONG_SYNC_RUN_H */
