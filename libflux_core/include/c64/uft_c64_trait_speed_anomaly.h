/*
 * ufm_c64_trait_speed_anomaly.h
 *
 * Speed-zone / bit-length anomaly
 *
 * Scope (preservation):
 ...
 */
#ifndef UFM_C64_TRAIT_SPEED_ANOMALY_H
#define UFM_C64_TRAIT_SPEED_ANOMALY_H
...
int ufm_c64_detect_trait_speed_anomaly(const ufm_c64_track_sig_t* tracks, size_t track_count,
...
#endif /* UFM_C64_TRAIT_SPEED_ANOMALY_H */
