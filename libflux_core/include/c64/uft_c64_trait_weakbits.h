/*
 * ufm_c64_trait_weakbits.h
 *
 * Weak bits / unstable data regions
 *
 * Scope (preservation):
 ...
 */
#ifndef UFM_C64_TRAIT_WEAKBITS_H
#define UFM_C64_TRAIT_WEAKBITS_H
...
int ufm_c64_detect_trait_weakbits(const ufm_c64_track_sig_t* tracks, size_t track_count,
...
#endif /* UFM_C64_TRAIT_WEAKBITS_H */
