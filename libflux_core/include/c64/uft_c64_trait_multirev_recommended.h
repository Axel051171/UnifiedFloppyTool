/*
 * ufm_c64_trait_multirev_recommended.h
 *
 * Multi-revolution capture recommended
 *
 * Scope (preservation):
 ...
 */
#ifndef UFM_C64_TRAIT_MULTIREV_RECOMMENDED_H
#define UFM_C64_TRAIT_MULTIREV_RECOMMENDED_H
...
int ufm_c64_detect_trait_multirev_recommended(const ufm_c64_track_sig_t* tracks, size_t track_count,
...
#endif /* UFM_C64_TRAIT_MULTIREV_RECOMMENDED_H */
