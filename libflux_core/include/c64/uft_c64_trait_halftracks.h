 ...
 */
#ifndef UFM_C64_TRAIT_HALFTRACKS_H
#define UFM_C64_TRAIT_HALFTRACKS_H
...
int ufm_c64_detect_trait_halftracks(const ufm_c64_track_sig_t* tracks, size_t track_count,
...
#endif /* UFM_C64_TRAIT_HALFTRACKS_H */
