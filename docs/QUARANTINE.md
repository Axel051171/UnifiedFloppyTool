...
| `src/formats/amiga/uft_amiga_protection.c` | 766 | „C99 **port** of XCopy Pro (1989-2011) 68000 Assembly algorithms", `:47` „Port of `ROL.L #1,D0`" — **keine Lizenz genannt** | **keine** — 0 Produktions-Aufrufer, 1 Test | **entfernen** — MF-744: die Lizenz liegt vor und gestattet **keine Bearbeitung** („private, non-commercial use", „governmental use is not permitted", Weitergabe nur vollständig und kostenlos; © 1988-2011 Anguilla Software International Ltd.). Unvereinbar mit GPL-2.0-or-later. Kein Nachbau: die Fakten sind zu 1 von 4 belegt und 2 widerlegt (MF-740). | entfällt |
