...
| P3-247 | **Die Geraetepfade sind weniger unpruefbar, als MF-310 sie erscheinen laesst.** Was fehlt, ist ein GERAET. Was nicht fehlt, sind AUFGEZEICHNETE STROEME von Geraeten | vom Eigentuemer vorgeschlagen; im Baum bereits einmal gemessen — der Korpus-Abzug trug den Befund ohne Geraet (MF-950) | ⚠ **offen, und der einzige Schritt, der die Geraetepfade wirklich bewegt.** KryoFlux-`.raw`-Stroeme und Greaseweazle-Rohaufnahmen liegen in oeffentlichen Archiven und Testsuiten; SCP-Dateien ohnehin. Ein aufgezeichneter Strom prueft den Geraetepfad gegen ECHTE BYTES, ohne dass das Geraet im Raum steht — dieselbe Cross-Tool-Klasse wie die Emulator-Abbilder, nur eine Schicht tiefer. **Der Beleg dafuer liegt schon vor:** `tests/corpus/gw_amigados.scp` hat in MF-950 den 99,71-%-Befund getragen, ohne dass ein Greaseweazle angeschlossen war. Damit rueckt „nur der Vertrag der Huelle" (MF-954) zu „gegen aufgezeichnete Wirklichkeit". Beschaffung als Scout-Auftrag |
