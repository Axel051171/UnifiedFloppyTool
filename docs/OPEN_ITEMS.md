...
| P0-15 | **Zwei Wahrheits-Fehler in der Wandlungs-Anzeige.** `SCP→G64` meldet 35 gewandelte Spuren und schreibt **789 Byte** (gemessen: 1 Byte je Spur, der PLL liefert ~8 Bit statt ~50000); `HFE→ADF` meldet „0 gewandelt, 160 gescheitert“ und liefert eine zu **99,92 %** korrekte Datei | **offen** — Zaehler in SCP→G64 behoben (MF-534), Ursachen eingegrenzt |
