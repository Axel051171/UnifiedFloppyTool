...
| `fdi` | **T2** | `test_fdi_spectrum` | SAMdisk ReadFDI (src/samdisk/fdi.cpp, in-tree) + WoS format FAQ | MF-359 | — |
| `hfe` | **T2** | `test_hfe_v3_weak` | HxC hfev3_loader.c opcode semantics (v3 decode + RAND weak bits); HxC HFE docs (v1) | MF-354, MF-362 | — |
...
| `scp` | **T2** | `test_protection_probe`, `test_scp_footer_roundtrip`, `test_scp_weakbit_multirev`, `test_scp_writer_roundtrip` | cbmstuff SCP image spec (48-byte FPCS footer, bitcell track length) | MF-318, MF-351 | — |
...
| `d71` | **T3** | `test_d71_write_roundtrip` | — | — | — |
| `d77` | **T3** | — | — | — | — |
| `d80` | **T3** | `test_d80_write_roundtrip` | — | — | — |
| `d81` | **T3** | `test_d81_write_roundtrip` | — | — | — |
