...
| `g64` | **T1** | `test_c64_metrics_corpus`, `test_c64_protection_real_corpus`, `test_format_probe_fuzz`, `test_plugin_probe_real` | — | — | 3 |
| `adf` | **T1b** | `test_adf_write_roundtrip`, `test_corpus_adf` | — | — | 1 |
| `atr` | **T1b** | `test_atr_512`, `test_atr_write_roundtrip`, `test_corpus_atr`, `test_format_probe_fuzz`, `test_plugin_probe_real` | — | — | 1 |
...
| `dim_atari` | **T3** | — | — | — | — |
| `dms` | **T3** | `test_uft_dms` | — | — | — |
| `do` | **T3** | `test_do_write_roundtrip`, `test_format_probe_fuzz`, `test_plugin_probe_real` | — | — | — |
| `edk` | **T3** | — | — | — | — |
...
| `opus` | **T3** | — | — | — | — |
| `pdp` | **T3** | — | — | — | — |
| `po` | **T3** | `test_format_probe_fuzz`, `test_plugin_probe_real`, `test_po_write_roundtrip` | — | — | — |
| `posix` | **T3** | — | — | — | — |
| `pri` | **T3** | — | — | — | — |
...
| `victor9k` | **T3** | — | — | — | — |
| `xdm86` | **T3** | — | — | — | — |
| `xfd` | **T3** | `test_format_probe_fuzz`, `test_plugin_probe_real` | — | — | — |
