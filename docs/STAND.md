...
|---|---|---|---|
| ungeprüfte **Format-Plugins** (T3) | **35** von 88 | runter | `docs/VERIFICATION_TIERS.md` |
...
- Fließtext-Attributionen (Verdachts-Stufe, `LIZ-1`): **188**
...
`docs/OPEN_ITEMS.md` führt **7592** Zeilen in **82** Abschnitten.
