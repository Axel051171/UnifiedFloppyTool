...
|---|---|---|---|
| ungeprüfte **Format-Plugins** (T3) | **20** von 88 | runter | `docs/VERIFICATION_TIERS.md` |
...
- Fließtext-Attributionen (Verdachts-Stufe, `LIZ-1`): **181**
...
`docs/OPEN_ITEMS.md` führt **7670** Zeilen in **82** Abschnitten.
