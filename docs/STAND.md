...
|---|---|---|---|
| ungeprüfte **Format-Plugins** (T3) | **10** von 88 | runter | `docs/VERIFICATION_TIERS.md` |
...
- Fließtext-Attributionen (Verdachts-Stufe, `LIZ-1`): **176**
...
`docs/OPEN_ITEMS.md` führt **7674** Zeilen in **82** Abschnitten.
