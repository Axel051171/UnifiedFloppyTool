...
|---|---|---|---|
| ungeprüfte **Format-Plugins** (T3) | **37** von 88 | runter | `docs/VERIFICATION_TIERS.md` |
...
- Fließtext-Attributionen (Verdachts-Stufe, `LIZ-1`): **175**
...
`docs/OPEN_ITEMS.md` führt **7462** Zeilen in **82** Abschnitten.
