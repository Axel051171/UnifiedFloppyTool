...
typedef struct {
    ...
    hxc_track_t *tracks;        /**< Track array */
 ...
 */
typedef struct {
    hxc_sector_t *sectors;  /**< Sector array */
...
/* Forward declaration */
typedef struct hxc_device_handle_t hxc_device_handle_t;
typedef struct hxc_device_info_t hxc_device_info_t;
