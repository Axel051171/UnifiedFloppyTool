...
Qt6 C/C++ Desktop-Applikation (~693 Quelldateien, ~17 Subsysteme;
...
Insgesamt aktuell 25. Die früher entfernten Agenten
...
Stand der Modelle: alle 25 Agenten laufen auf `claude-fable-5`
...
### Aufklärungs-Suite (3, post-v4.1.6)

Alle drei liefern **nur Dokumente**, nie Code. Der Unterschied ist die
...
hält?“). Scout und Varianten-Sucher teilen sich die Referenz-Klone
...
2. **Direkter Agent-Spawn (sparsam):** Nur 4 von 25 Agenten haben
