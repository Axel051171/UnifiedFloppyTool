...
/* ============================================================================
 * Forward Declarations (compatible with libflux.h)
 * ============================================================================ */

/* Use forward declarations - actual structs defined in libflux.h or here */
...
/* LIBFLUX_CTX is the same as LIBFLUX in libflux.h */
typedef struct LIBFLUX_ LIBFLUX_CTX;
#endif
...
/* ============================================================================
 * Sector Configuration (Extended Version)
 * This is the full sector configuration used by track generation.
 * ============================================================================ */

#ifndef LIBFLUX_SECTCFG_EXT_DEFINED
#define LIBFLUX_SECTCFG_EXT_DEFINED

typedef struct LIBFLUX_SECTCFG_EXT_
{
    int32_t        head;
    int32_t        sector;
    int32_t        sectorsleft;
...
/* For backward compatibility - use the extended type */
#ifndef _LIBFLUX_SECTCFG_
#define _LIBFLUX_SECTCFG_
typedef LIBFLUX_SECTCFG_EXT LIBFLUX_SECTCFG;
#endif

#endif /* LIBFLUX_SECTCFG_EXT_DEFINED */

/* ============================================================================
 * Function Declarations
 * ============================================================================ */

int32_t pushTrackCode(
    track_generator* tg,
    uint8_t data,
    uint8_t clock,
    LIBFLUX_SIDE* side,
...
int32_t tg_computeMinTrackSize(
    track_generator* tg,
    int32_t trackencoding,
    int32_t bitrate,
...
void tg_addSectorToTrack(
    track_generator* tg,
    LIBFLUX_SECTCFG* sectorconfig,
    LIBFLUX_SIDE* currentside
);

void tg_completeTrack(
    track_generator* tg,
    LIBFLUX_SIDE* currentside,
    int32_t trackencoding
);

LIBFLUX_SIDE* tg_initTrack(
    track_generator* tg,
    int32_t tracksize,
    int32_t numberofsector,
    int32_t trackencoding,
