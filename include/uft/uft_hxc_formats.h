/**
 * @file uft_hxc_formats.h
 * @brief HxC Format Structures and Loaders for UFT
 * 
 * This file contains format structures extracted from HxC Floppy Emulator
...
#ifndef UFT_HXC_FORMATS_H
#define UFT_HXC_FORMATS_H
