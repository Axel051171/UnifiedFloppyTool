 ...
 */
typedef struct __attribute__((packed)) uft_dos33_vtoc {
 ...
 */
typedef struct __attribute__((packed)) uft_dos33_catalog_sector {
 ...
 */
typedef struct __attribute__((packed)) uft_dos33_file_entry {
 ...
 */
typedef struct __attribute__((packed)) uft_prodos_vdh {
 ...
 */
typedef struct __attribute__((packed)) uft_prodos_file_entry {
    uint8_t  storage_name_len;      /**< Storage Type (high nibble) + Name Len */
 ...
 */
typedef struct __attribute__((packed)) uft_2mg_header {
    uint32_t magic;                 /**< "2IMG" */
