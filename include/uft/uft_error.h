...
#define UFT_ERROR_GEOMETRY_MISMATCH    UFT_ERR_FORMAT    /* Disk-API */
#define UFT_ERROR_CONVERSION_LOSSY     UFT_ERR_FORMAT    /* Disk-API */
#define UFT_ERROR_TRANSACTION_CONFLICT UFT_ERR_INVALID_ARG
#define UFT_ERROR_TRANSACTION_LIMIT    UFT_ERR_INTERNAL
