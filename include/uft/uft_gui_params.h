 ...
 *
 * This header declares 16 public functions, of which 16 have no
...
/* Forward declarations for internal config structs */
struct uft_dpll_config;
struct uft_adaptive_config;
