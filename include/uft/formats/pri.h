#ifndef UFT_FORMATS_PRI_H
#define UFT_FORMATS_PRI_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `pri.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/pri.h"` aufloest, und enthaelt bewusst keine
