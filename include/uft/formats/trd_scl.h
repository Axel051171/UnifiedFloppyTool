#ifndef UFT_FORMATS_TRD_SCL_H
#define UFT_FORMATS_TRD_SCL_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `trd_scl.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/trd_scl.h"` aufloest, und enthaelt bewusst keine
