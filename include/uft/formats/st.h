#ifndef UFT_FORMATS_ST_H
#define UFT_FORMATS_ST_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `st.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/st.h"` aufloest, und enthaelt bewusst keine
