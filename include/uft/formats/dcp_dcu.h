#ifndef UFT_FORMATS_DCP_DCU_H
#define UFT_FORMATS_DCP_DCU_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `dcp_dcu.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/dcp_dcu.h"` aufloest, und enthaelt bewusst keine
