#ifndef UFT_FORMATS_ST_MSA_H
#define UFT_FORMATS_ST_MSA_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `st_msa.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/st_msa.h"` aufloest, und enthaelt bewusst keine
