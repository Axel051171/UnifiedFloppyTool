#ifndef UFT_FORMATS_2MG_H
#define UFT_FORMATS_2MG_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `2mg.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/2mg.h"` aufloest, und enthaelt bewusst keine
