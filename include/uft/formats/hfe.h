#ifndef UFT_FORMATS_HFE_H
#define UFT_FORMATS_HFE_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `hfe.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/hfe.h"` aufloest, und enthaelt bewusst keine
