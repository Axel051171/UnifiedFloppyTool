#ifndef UFT_FORMATS_OPD_H
#define UFT_FORMATS_OPD_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `opd.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/opd.h"` aufloest, und enthaelt bewusst keine
