#ifndef UFT_FORMATS_DHD_H
#define UFT_FORMATS_DHD_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `dhd.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/dhd.h"` aufloest, und enthaelt bewusst keine
