#ifndef UFT_FORMATS_ADF_H
#define UFT_FORMATS_ADF_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `adf.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/adf.h"` aufloest, und enthaelt bewusst keine
