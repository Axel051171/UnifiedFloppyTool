#ifndef UFT_FORMATS_DSK_H
#define UFT_FORMATS_DSK_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `dsk.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/dsk.h"` aufloest, und enthaelt bewusst keine
