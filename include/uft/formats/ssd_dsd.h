#ifndef UFT_FORMATS_SSD_DSD_H
#define UFT_FORMATS_SSD_DSD_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `ssd_dsd.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/ssd_dsd.h"` aufloest, und enthaelt bewusst keine
