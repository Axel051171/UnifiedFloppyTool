#ifndef UFT_FORMATS_STX_H
#define UFT_FORMATS_STX_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `stx.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/stx.h"` aufloest, und enthaelt bewusst keine
