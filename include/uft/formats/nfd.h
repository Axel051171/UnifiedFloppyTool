#ifndef UFT_FORMATS_NFD_H
#define UFT_FORMATS_NFD_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `nfd.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/nfd.h"` aufloest, und enthaelt bewusst keine
