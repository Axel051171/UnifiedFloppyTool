#ifndef UFT_FORMATS_FDX_H
#define UFT_FORMATS_FDX_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `fdx.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/fdx.h"` aufloest, und enthaelt bewusst keine
