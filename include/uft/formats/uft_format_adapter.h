#ifndef UFT_FORMATS_FORMAT_ADAPTER_H
#define UFT_FORMATS_FORMAT_ADAPTER_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `uft_format_adapter.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/uft_format_adapter.h"` aufloest, und enthaelt bewusst keine
...
#endif /* UFT_FORMATS_FORMAT_ADAPTER_H */
