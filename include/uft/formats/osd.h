#ifndef UFT_FORMATS_OSD_H
#define UFT_FORMATS_OSD_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `osd.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/osd.h"` aufloest, und enthaelt bewusst keine
