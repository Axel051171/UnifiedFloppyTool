#ifndef UFT_FORMATS_LNX_H
#define UFT_FORMATS_LNX_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `lnx.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/lnx.h"` aufloest, und enthaelt bewusst keine
