#ifndef UFT_FORMATS_MGT_SAD_SDF_H
#define UFT_FORMATS_MGT_SAD_SDF_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `mgt_sad_sdf.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/mgt_sad_sdf.h"` aufloest, und enthaelt bewusst keine
...
#endif /* UFT_FORMATS_MGT_SAD_SDF_H */
