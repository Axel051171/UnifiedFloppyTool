#ifndef UFT_FORMATS_HDM_H
#define UFT_FORMATS_HDM_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `hdm.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/hdm.h"` aufloest, und enthaelt bewusst keine
