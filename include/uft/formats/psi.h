#ifndef UFT_FORMATS_PSI_H
#define UFT_FORMATS_PSI_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `psi.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/psi.h"` aufloest, und enthaelt bewusst keine
