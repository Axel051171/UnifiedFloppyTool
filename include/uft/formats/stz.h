#ifndef UFT_FORMATS_STZ_H
#define UFT_FORMATS_STZ_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `stz.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/stz.h"` aufloest, und enthaelt bewusst keine
