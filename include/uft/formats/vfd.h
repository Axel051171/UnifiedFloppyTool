#ifndef UFT_FORMATS_VFD_H
#define UFT_FORMATS_VFD_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `vfd.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/vfd.h"` aufloest, und enthaelt bewusst keine
