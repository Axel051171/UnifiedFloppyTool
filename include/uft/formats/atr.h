#ifndef UFT_FORMATS_ATR_H
#define UFT_FORMATS_ATR_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `atr.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/atr.h"` aufloest, und enthaelt bewusst keine
