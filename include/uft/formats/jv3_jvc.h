#ifndef UFT_FORMATS_JV3_JVC_H
#define UFT_FORMATS_JV3_JVC_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `jv3_jvc.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/jv3_jvc.h"` aufloest, und enthaelt bewusst keine
