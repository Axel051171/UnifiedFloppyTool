#ifndef UFT_FORMATS_EDD_H
#define UFT_FORMATS_EDD_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `edd.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/edd.h"` aufloest, und enthaelt bewusst keine
