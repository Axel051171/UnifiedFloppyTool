#ifndef UFT_FORMATS_TAP_H
#define UFT_FORMATS_TAP_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `tap.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/tap.h"` aufloest, und enthaelt bewusst keine
