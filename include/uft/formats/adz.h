#ifndef UFT_FORMATS_ADZ_H
#define UFT_FORMATS_ADZ_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `adz.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/adz.h"` aufloest, und enthaelt bewusst keine
