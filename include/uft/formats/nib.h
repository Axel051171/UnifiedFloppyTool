#ifndef UFT_FORMATS_NIB_H
#define UFT_FORMATS_NIB_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `nib.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/nib.h"` aufloest, und enthaelt bewusst keine
