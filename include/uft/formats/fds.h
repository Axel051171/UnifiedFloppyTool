#ifndef UFT_FORMATS_FDS_H
#define UFT_FORMATS_FDS_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `fds.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/fds.h"` aufloest, und enthaelt bewusst keine
