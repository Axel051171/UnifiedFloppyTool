#ifndef UFT_FORMATS_NIB_NBZ_H
#define UFT_FORMATS_NIB_NBZ_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `nib_nbz.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/nib_nbz.h"` aufloest, und enthaelt bewusst keine
