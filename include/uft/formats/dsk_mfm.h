#ifndef UFT_FORMATS_DSK_MFM_H
#define UFT_FORMATS_DSK_MFM_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `dsk_mfm.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/dsk_mfm.h"` aufloest, und enthaelt bewusst keine
