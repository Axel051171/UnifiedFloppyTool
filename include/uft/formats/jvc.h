#ifndef UFT_FORMATS_JVC_H
#define UFT_FORMATS_JVC_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `jvc.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/jvc.h"` aufloest, und enthaelt bewusst keine
