#ifndef UFT_FORMATS_MAC_DSK_H
#define UFT_FORMATS_MAC_DSK_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `mac_dsk.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/mac_dsk.h"` aufloest, und enthaelt bewusst keine
