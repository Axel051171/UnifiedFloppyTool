#ifndef UFT_FORMATS_SCP_H
#define UFT_FORMATS_SCP_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `scp.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/scp.h"` aufloest, und enthaelt bewusst keine
