#ifndef UFT_FORMATS_EDSK_EXTDSK_H
#define UFT_FORMATS_EDSK_EXTDSK_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `edsk_extdsk.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/edsk_extdsk.h"` aufloest, und enthaelt bewusst keine
...
#endif /* UFT_FORMATS_EDSK_EXTDSK_H */
