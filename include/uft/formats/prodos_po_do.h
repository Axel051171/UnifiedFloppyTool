#ifndef UFT_FORMATS_PRODOS_PO_DO_H
#define UFT_FORMATS_PRODOS_PO_DO_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `prodos_po_do.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/prodos_po_do.h"` aufloest, und enthaelt bewusst keine
...
#endif /* UFT_FORMATS_PRODOS_PO_DO_H */
