#ifndef UFT_FORMATS_GWRAW_H
#define UFT_FORMATS_GWRAW_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `gwraw.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/gwraw.h"` aufloest, und enthaelt bewusst keine
