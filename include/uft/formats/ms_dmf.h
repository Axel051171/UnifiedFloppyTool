#ifndef UFT_FORMATS_MS_DMF_H
#define UFT_FORMATS_MS_DMF_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `ms_dmf.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/ms_dmf.h"` aufloest, und enthaelt bewusst keine
