#ifndef UFT_FORMATS_DETECT_H
#define UFT_FORMATS_DETECT_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `uft_detect.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/uft_detect.h"` aufloest, und enthaelt bewusst keine
