#ifndef UFT_FORMATS_CQM_H
#define UFT_FORMATS_CQM_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `cqm.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/cqm.h"` aufloest, und enthaelt bewusst keine
