#ifndef UFT_FORMATS_DFI_H
#define UFT_FORMATS_DFI_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `dfi.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/dfi.h"` aufloest, und enthaelt bewusst keine
