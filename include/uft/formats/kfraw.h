#ifndef UFT_FORMATS_KFRAW_H
#define UFT_FORMATS_KFRAW_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `kfraw.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/kfraw.h"` aufloest, und enthaelt bewusst keine
