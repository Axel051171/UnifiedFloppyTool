#ifndef UFT_FORMATS_XDF_H
#define UFT_FORMATS_XDF_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `xdf.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/xdf.h"` aufloest, und enthaelt bewusst keine
