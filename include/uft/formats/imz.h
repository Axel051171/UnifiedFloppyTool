#ifndef UFT_FORMATS_IMZ_H
#define UFT_FORMATS_IMZ_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `imz.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/imz.h"` aufloest, und enthaelt bewusst keine
