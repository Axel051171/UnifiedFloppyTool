#ifndef UFT_FORMATS_XFD_H
#define UFT_FORMATS_XFD_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `xfd.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/xfd.h"` aufloest, und enthaelt bewusst keine
