#ifndef UFT_FORMATS_FDI_H
#define UFT_FORMATS_FDI_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `fdi.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/fdi.h"` aufloest, und enthaelt bewusst keine
