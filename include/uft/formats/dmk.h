#ifndef UFT_FORMATS_DMK_H
#define UFT_FORMATS_DMK_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `dmk.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/dmk.h"` aufloest, und enthaelt bewusst keine
