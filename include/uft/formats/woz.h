 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `woz.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/woz.h"` aufloest, und enthaelt bewusst keine
