#ifndef UFT_FORMATS_ORIC_DSK_H
#define UFT_FORMATS_ORIC_DSK_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `oric_dsk.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/oric_dsk.h"` aufloest, und enthaelt bewusst keine
