#ifndef UFT_FORMATS_DIM_H
#define UFT_FORMATS_DIM_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `dim.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/dim.h"` aufloest, und enthaelt bewusst keine
