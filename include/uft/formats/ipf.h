#ifndef UFT_FORMATS_IPF_H
#define UFT_FORMATS_IPF_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `ipf.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/ipf.h"` aufloest, und enthaelt bewusst keine
