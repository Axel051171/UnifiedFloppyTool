#ifndef UFT_FORMATS_D88_H
#define UFT_FORMATS_D88_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `d88.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/d88.h"` aufloest, und enthaelt bewusst keine
