#ifndef UFT_FORMATS_F86_H
#define UFT_FORMATS_F86_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `f86.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/f86.h"` aufloest, und enthaelt bewusst keine
