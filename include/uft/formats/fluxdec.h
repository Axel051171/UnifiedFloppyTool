#ifndef UFT_FORMATS_FLUXDEC_H
#define UFT_FORMATS_FLUXDEC_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `fluxdec.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/fluxdec.h"` aufloest, und enthaelt bewusst keine
