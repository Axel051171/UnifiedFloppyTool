#ifndef UFT_FORMATS_TD0_H
#define UFT_FORMATS_TD0_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `td0.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/td0.h"` aufloest, und enthaelt bewusst keine
