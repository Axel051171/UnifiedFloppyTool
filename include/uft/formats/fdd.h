#ifndef UFT_FORMATS_FDD_H
#define UFT_FORMATS_FDD_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `fdd.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/fdd.h"` aufloest, und enthaelt bewusst keine
