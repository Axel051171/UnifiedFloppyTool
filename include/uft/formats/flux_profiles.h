#ifndef UFT_FORMATS_FLUX_PROFILES_H
#define UFT_FORMATS_FLUX_PROFILES_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `flux_profiles.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/flux_profiles.h"` aufloest, und enthaelt bewusst keine
...
#endif /* UFT_FORMATS_FLUX_PROFILES_H */
