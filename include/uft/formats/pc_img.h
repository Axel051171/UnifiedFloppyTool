#ifndef UFT_FORMATS_PC_IMG_H
#define UFT_FORMATS_PC_IMG_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `pc_img.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/pc_img.h"` aufloest, und enthaelt bewusst keine
