#ifndef UFT_FORMATS_DMF_MSX_H
#define UFT_FORMATS_DMF_MSX_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `dmf_msx.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/dmf_msx.h"` aufloest, und enthaelt bewusst keine
