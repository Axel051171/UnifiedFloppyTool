#ifndef UFT_FORMATS_STT_H
#define UFT_FORMATS_STT_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `stt.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/stt.h"` aufloest, und enthaelt bewusst keine
