#ifndef UFT_FORMATS_SF7_H
#define UFT_FORMATS_SF7_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `sf7.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/sf7.h"` aufloest, und enthaelt bewusst keine
