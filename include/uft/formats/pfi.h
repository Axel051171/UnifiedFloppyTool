#ifndef UFT_FORMATS_PFI_H
#define UFT_FORMATS_PFI_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `pfi.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/pfi.h"` aufloest, und enthaelt bewusst keine
