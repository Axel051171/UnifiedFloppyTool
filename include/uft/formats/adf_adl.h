#ifndef UFT_FORMATS_ADF_ADL_H
#define UFT_FORMATS_ADF_ADL_H
 ...
 * Er las sich wie ein Gestaendnis: wer ihn in `adf_adl.h` fand, schloss daraus, die
 ...
 * `#include "uft/formats/adf_adl.h"` aufloest, und enthaelt bewusst keine
