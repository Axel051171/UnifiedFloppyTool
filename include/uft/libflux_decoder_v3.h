...
typedef struct libflux_decoder_v3 libflux_decoder_v3_t;
...
void libflux_v3_set_progress_callback(libflux_decoder_v3_t* dec,
                                   void (*cb)(int, int, float, void*),
                                   void* user_data);

void libflux_v3_set_error_callback(libflux_decoder_v3_t* dec,
