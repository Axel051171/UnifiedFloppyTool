 ...
 */
typedef struct __attribute__((packed)) uft_apm_block0 {
 ...
 */
typedef struct __attribute__((packed)) uft_apm_ddmap {
 ...
 */
typedef struct __attribute__((packed)) uft_apm_dpme {
 ...
 */
typedef struct __attribute__((packed)) uft_hfs_mdb {
 ...
 * Liegt bei Block 2 (Offset 0x400) eines HFS+ Volumes
 */
typedef struct __attribute__((packed)) uft_hfsplus_header {
 ...
 */
typedef struct __attribute__((packed)) uft_hfsplus_fork {
 ...
 */
typedef struct __attribute__((packed)) uft_btree_node_desc {
 ...
 */
typedef struct __attribute__((packed)) uft_btree_header {
 ...
 */
typedef struct __attribute__((packed)) uft_hfsplus_catalog_key {
 ...
 */
typedef struct __attribute__((packed)) uft_hfsplus_folder_record {
 ...
 */
typedef struct __attribute__((packed)) uft_hfsplus_file_record {
 ...
 */
typedef struct __attribute__((packed)) uft_hfs_compress_header {
