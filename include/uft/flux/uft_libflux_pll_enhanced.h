/**
 * @file uft_libflux_pll_enhanced.h
 * @version 1.0.0
 * @date 2026-01-06
 *
 *
...
#ifndef UFT_LIBFLUX_PLL_ENHANCED_H
#define UFT_LIBFLUX_PLL_ENHANCED_H
...
#define UFT_LIBFLUX_HISTOGRAM_SIZE      65536

/** Maximum band separators */
#define UFT_LIBFLUX_MAX_BANDS           16

/** Inter-band rejection modes */
#define UFT_LIBFLUX_BAND_NONE           0
#define UFT_LIBFLUX_BAND_GCR            1   /**< GCR encoding (reject 3,5 cells) */
#define UFT_LIBFLUX_BAND_FM             2   /**< FM encoding (force 2,4 cells) */
...
typedef enum {
    UFT_LIBFLUX_ENC_UNKNOWN     = 0,
    UFT_LIBFLUX_ENC_DD_250K     = 1,    /**< Double Density 250 kbit/s (PC DD) */
    UFT_LIBFLUX_ENC_DD_300K     = 2,    /**< Double Density 300 kbit/s (Amiga/Atari) */
    UFT_LIBFLUX_ENC_HD          = 3,    /**< High Density 500 kbit/s */
    UFT_LIBFLUX_ENC_ED          = 4,    /**< Extra Density 1 Mbit/s */
} uft_libflux_encoding_t;
...
typedef struct {
    ...
    int bands_separators[UFT_LIBFLUX_MAX_BANDS];
...
typedef struct {
    ...
    uft_libflux_encoding_t encoding;    /**< Detected encoding type */
} uft_libflux_bitrate_t;
 ...
 * @param pll PLL state
 * @param mode UFT_LIBFLUX_BAND_NONE, UFT_LIBFLUX_BAND_GCR, or UFT_LIBFLUX_BAND_FM
 */
 ...
 * @param outdata Output histogram (must be UFT_LIBFLUX_HISTOGRAM_SIZE)
 */
...
#endif /* UFT_LIBFLUX_PLL_ENHANCED_H */
